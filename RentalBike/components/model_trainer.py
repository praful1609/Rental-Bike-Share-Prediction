...
from RentalBike.entity.config_entity import ModelTrainerConfig
from RentalBike.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
...
class ModelTrainer:
    ...
    def Random_Forest_Regressor(self,x_train,y_train):
        try:
            ...
            rf = RandomForestRegressor(**rf_best_params,criterion="squared_error",random_state=21)
    ...
    def XGBoost_Regressor(self,x_train,y_train,x_test,y_test):
        try:
            ...
            xgb = XGBRegressor(objective="reg:squarederror", random_state = 786,**xgb_best_params)
