...
import pandas as pd
from RentalBike.components.dbOperation import MongoDB
...
class DataIngestion:
    ...
    logging.info("Starting downloading the zipped dataset from given url")
    def download_data(self):
        ...
        try:
            ...
            logging.info(f"Extracting remote url to download dataset files")
            download_url = self.data_ingestion_config.dataset_download_url

            # folder location to download zipped file
            logging.info("folder location to download zipped file")
    ...
    logging.info("Merging then spliting the data")
