...
from RentalBike.entity.config_entity import DataValidationConfig, DataIngestionConfig
from RentalBike.entity.artifact_entity import DataValidationArtifact, DataIngestionArtifact
